...
import static org.cadenzaflow.bpm.extension.keycloak.json.JsonUtil.*;
...
import org.cadenzaflow.bpm.engine.identity.NativeUserQuery;
import org.cadenzaflow.bpm.engine.identity.Tenant;
import org.cadenzaflow.bpm.engine.identity.TenantQuery;
import org.cadenzaflow.bpm.engine.identity.User;
import org.cadenzaflow.bpm.engine.identity.UserQuery;
import org.cadenzaflow.bpm.engine.impl.UserQueryImpl;
...
import org.cadenzaflow.bpm.extension.keycloak.json.JsonException;
import org.cadenzaflow.bpm.extension.keycloak.rest.KeycloakRestTemplate;
import org.cadenzaflow.bpm.extension.keycloak.util.ContentType;
import org.cadenzaflow.bpm.extension.keycloak.util.KeycloakPluginLogger;
...
public class KeycloakIdentityProviderSession implements ReadOnlyIdentityProvider {
	...
	public User findUserById(String userId) {
		return createUserQuery(org.cadenzaflow.bpm.engine.impl.context.Context.getCommandContext()).userId(userId)
				.singleResult();
	}
	...
	public UserQuery createUserQuery() {
		return new KeycloakUserQuery(org.cadenzaflow.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
	 ...
	 * 
	 * @see org.cadenzaflow.bpm.extension.keycloak.KeycloakUserService#getKeycloakAdminUserId(java.lang.String)
	 */
	...
	public Group findGroupById(String groupId) {
		return createGroupQuery(org.cadenzaflow.bpm.engine.impl.context.Context.getCommandContext()).groupId(groupId)
				.singleResult();
	}
	...
	public GroupQuery createGroupQuery() {
		return new KeycloakGroupQuery(org.cadenzaflow.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
				.getCommandExecutorTxRequired());
	}
	 ...
	 * 
	 * @see org.cadenzaflow.bpm.extension.keycloak.KeycloakGroupService#getKeycloakAdminGroupId(java.lang.String)
	 */
	...
	public TenantQuery createTenantQuery() {
		return new KeycloakTenantQuery(org.cadenzaflow.bpm.engine.impl.context.Context.getProcessEngineConfiguration()
				.getCommandExecutorTxRequired());
	}
