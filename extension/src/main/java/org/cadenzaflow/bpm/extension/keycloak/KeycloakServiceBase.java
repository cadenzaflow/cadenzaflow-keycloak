...
import org.cadenzaflow.bpm.engine.authorization.Permission;
import org.cadenzaflow.bpm.engine.authorization.Resource;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.UserEntity;
...
public abstract class KeycloakServiceBase {
	...
	protected boolean isAuthenticatedUser(String userId) {
		...
		return userId.equalsIgnoreCase(
				org.cadenzaflow.bpm.engine.impl.context.Context.getCommandContext().getAuthenticatedUserId());
	}
	...
	protected boolean isAuthorized(Permission permission, Resource resource, String resourceId) {
		return !keycloakConfiguration.isAuthorizationCheckEnabled() || org.cadenzaflow.bpm.engine.impl.context.Context
