package org.cadenzaflow.bpm.extension.keycloak.util;

import org.cadenzaflow.commons.logging.BaseLogger;
...
public class KeycloakPluginLogger extends BaseLogger {
	...
	public static final KeycloakPluginLogger INSTANCE = BaseLogger.createLogger(
			KeycloakPluginLogger.class, PROJECT_CODE, "org.cadenzaflow.bpm.extension.keycloak", "01");
